    ...
    return Wrap(
      children: [
        ...
        CustomIconButton(
          ...
          tooltip: 'print'.tr,
          onPressed: () async {
            context.read<InvoicePrinterCubit>().printTaxInvoice(context);
          },
        ),
        CustomIconButton(
          icon: Icons.receipt,
          ...
          onPressed: () {
            context.read<InvoicePrinterCubit>().printReceipt(context);
          },
        ),
        CustomIconButton(
          ...
          tooltip: 'export'.tr,
          onPressed: () {
            context.read<InvoicePrinterCubit>().printA4Invoice(context);
          },
        ),
        CustomIconButton(
          icon: Icons.refresh,
